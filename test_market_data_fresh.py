...
# Тестирование с известными крупными тикерами
test_tickers = ["AAPL", "MSFT", "GOOGL", "AMZN", "TSLA"]
print(f"\nТестирование получения СВЕЖИХ данных для известных тикеров: {', '.join(test_tickers)}")

for ticker in test_tickers:
    try:
        print(f"\nПолучение данных для {ticker} с принудительным обновлением...")
        ticker_data = service.get_ticker_data(ticker, force_refresh=True)
